...
public class HashMapIndirecte<K, V extends Comparable<V>> implements IHashMap<K, V>{
    ...
    public K[] obtenirClaus() {
        Object[] claus = new Object[numElem];
        //int j = 0;
        int i = 0;
        /*for (i = 0; i < midaFixe; i++) {
            if(llista.get(i)!=null){
                claus[j] = llista.get(i).key;
                j++;
            }
        }
